 ...
 */
class Client extends \Schakel\Model\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'redirectUrl', 'secret', 'owner', 'authorizationTokens', 'accessTokens', 'id'];
        }
