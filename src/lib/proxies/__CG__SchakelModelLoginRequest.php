 ...
 */
class LoginRequest extends \Schakel\Model\LoginRequest implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'state', 'redirectUrl', 'sessionId', 'expire', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LoginRequest $proxy) {
