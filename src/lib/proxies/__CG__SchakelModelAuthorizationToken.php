 ...
 */
class AuthorizationToken extends \Schakel\Model\AuthorizationToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'redirectUrl', 'code', 'client', 'user', 'expire', 'created', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AuthorizationToken $proxy) {
